...
function checkStorageHealth() {
  try {
    ...
    ensureFile(draftsFile, {});
    ensureFile(emailLogFile, []);

    fs.accessSync(dataDir, fs.constants.R_OK | fs.constants.W_OK);
    fs.accessSync(applicationsFile, fs.constants.R_OK | fs.constants.W_OK);
    fs.accessSync(draftsFile, fs.constants.R_OK | fs.constants.W_OK);
    fs.accessSync(emailLogFile, fs.constants.R_OK | fs.constants.W_OK);
